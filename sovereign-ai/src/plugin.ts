...
import { LocalOpenAiAdapter } from "./models/local-provider.js";
import type { LocalModelEndpoint } from "./models/local-provider.js";
import { createRoutingService, installRouting } from "./router/router.js";
import { createRagService, registerRagTool } from "./rag/search-tool.js";
import type { RagConfig } from "./rag/search-tool.js";
import { registerDocumentTools } from "./documents/pdf.js";
import type { DocumentToolsConfig } from "./documents/pdf.js";
import { registerArtifactTools } from "./artifacts/docx.js";
import type { ArtifactToolsConfig } from "./artifacts/docx.js";
import {
...
import { createAuditTrace, installAuditTrace } from "./audit/trace.js";
import type { AuditConfig } from "./audit/trace.js";
...
export { LocalOpenAiAdapter, routeFor } from "./models/local-provider.js";
export type {
  LocalModelEndpoint,
  LocalModelsConfig,
} from "./models/local-provider.js";
export { createRagService, registerRagTool } from "./rag/search-tool.js";
export type {
  RagConfig,
  RagResult,
  RagService,
...
export { createDocumentTools, registerDocumentTools } from "./documents/pdf.js";
export type {
  DocumentInspection,
  DocumentPage,
  DocumentTable,
...
export { createAuditTrace, installAuditTrace } from "./audit/trace.js";
export type {
  AuditConfig,
  AuditEntry,
  AuditTraceService,
